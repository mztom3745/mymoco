...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.aug_plus:
        ...
        augmentation = [
            transforms.RandomResizedCrop(255, scale=(0.6, 1.0)),#224to255 and 0.2to0.6
            ...
            impash.loader.PatchShuffling(),#255to196
            transforms.ToTensor(),
            normalize,
        ]
    else:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (
            ...
            save_checkpoint(
                ...
                is_best=False,
                filename="impashv222_{:04d}.pth.tar".format(epoch),
            )
