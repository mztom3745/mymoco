...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.aug_plus:
        ...
        augmentation1 = [ #useless
            transforms.RandomResizedCrop(224, scale=(0.2, 1.0)),#changed to 192 and 0.6
            transforms.RandomGrayscale(p=0.2),
    ...
    augmentation2 = [
        transforms.RandomResizedCrop(96, scale=(0.1, 0.5)),
        #transforms.RandomApply(
        #    [transforms.ColorJitter(0.4, 0.4, 0.4, 0.1)], p=0.8  # not strengthened
        #),
        transforms.RandomGrayscale(p=0.2),
        ...
        if not args.multiprocessing_distributed or (
            ...
            if epoch % 10 == 9 or epoch == 0:
                save_checkpoint(
                    ...
                    is_best=False,
                    filename="multi_crop_{:04d}.pth.tar".format(epoch),
                )
